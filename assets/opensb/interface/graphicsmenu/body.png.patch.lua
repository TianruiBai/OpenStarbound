function patch(original)
  local image = original:process("?crop=0;0;1;1?scalenearest=336;166")
  ...
  image:copyInto({219, 26}, checkbox) -- VSync
  ...
  image:copyInto({119, 96}, image:process("?crop=19;68;117;87")) -- Maximum FPS
