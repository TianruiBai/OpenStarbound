...
```text
GameMechanismCapture clients=4 ticks=240 packets=22621 step=960 tileArray=100 tile=3116 liquid=16484 tileDamage=1008 entityCreate=92 entityUpdate=780 entityUpdateDeltas=4800 emptyEntityUpdate=0 entityDestroy=40 giveItem=1 failures=0 packetPrepTicks=240 regions=960/960/960/2160 sectorCache=100/0 entityStoreCache=69/23 netStateCache=8127/7517 updateSets=780/4800/0/180 sectorFanout=5179/20716/0 liquidCache=12/48/48/320/4857/19428/4857 falling=30/1216/1537/324 wiring=48/144/144/144/144 entity=240/3944/720/10/3944/3944/44/176/15791/646 lua=240/240/240/680/87 storage=1/64/64/64/66/65/1/65/6285 chunks=65 elapsedUs=189429
```

Important reads:

- Liquid fan-out remains the largest packet class in this synthetic capture: `16484` liquid update packets and `sectorFanout=5179/20716/0`.
- The liquid cache rebuild-skip optimization is active under stable monitoring windows: `liquidCache=12/48/...`.
- Tile-update, tile-damage, and falling-block paths are now nonzero: `tile=3116`, `tileDamage=1008`, `falling=30/1216/1537/324`.
...
- Empty entity update-set suppression is measured but still opt-in: the capture emitted `780` update sets, carried `4800` deltas, emitted `0` empty update sets, and skipped `180` empty update sets. The immediately preceding legacy-compatible run emitted `960` update sets with the same `4800` deltas and `180` empty update-set packets.
- Delta net-state cache now shows both reuse and misses: `netStateCache=8127/7517`. This should still be investigated, but not by blindly caching first-observation bytes.
- Entity compatibility-layer attribution is now nonzero: `entity=240/3944/720/10/3944/3944/44/176/15791/646` means ticks/updated/tile/destroyed/copied/sorted/copyUs/sortUs/updateUs/metadataUs.
- Lua compatibility-layer attribution is now nonzero for the OpenStarbound world script context: `lua=240/240/240/680/87` means ticks/contexts/updates/updateUs/maxSingleUpdateUs.
- Storage remains measurable: `storage=1/64/64/64/66/65/1/65/6285`, including a full snapshot export.
...
The capture's `netStateCache=8127/7517` makes entity replication a good research target, but the version-advancement contract is the gate.
