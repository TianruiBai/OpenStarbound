...
String CommandProcessor::worldStats(ConnectionId connectionId, String const&) {
  ...
  for (auto const& world : summary.worlds) {
    ...
    lines.append(strf("world {}: state={}, clients={}, commands=pending:{} oldestPendingUs:{} processed:{} direct:{} failed:{} waitUs:{}, packetPrep=ticks:{} regions:{}/{}/{}/{} sectorCache:{}/{} entityStoreCache:{}/{} netStateCache:{}/{} entityUpdateSets:{}/{}/{}/{} sectorFanout:{}/{}/{} entitySerialize:{} storageTiming={}, phase6=storage:{}/{}/{} sectors:{} fallbacks:{} divergences:{} packetPrefill:{}/{}/{} sectors:{} fallbacks:{} divergences:{} baselines:liquid:{} liquidCache:{}/{}/{}/{}/{}/{}/{} falling:{} wiring:{}/{}/{}/{}/{} dirty:{}/{}/{}/{}/{}/{}/{} entity:{}/{}/{}/{}/{}/{}/{}/{}/{}/{} lua:{}/{}/{}/{}/{} mutation=requested:{} blocked:fixedSeed:{} dependency:{} modVisibility:{} implementation:{}",
