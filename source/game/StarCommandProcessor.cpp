...
String CommandProcessor::serverStatus(ConnectionId connectionId, String const&) {
  ...
  lines.append(strf("Phase 6 packet sector prefill: enabledWorlds={}, ticks={}, serialTicks={}, parallelTicks={}, sectors={}, serialUs={}, parallelUs={}, mergeUs={}, fallbacks={}, diffWorlds={}, diffChecks={}, diffUs={}, divergences={}",
    ...
    lines.append(strf("Phase 6 subsystem baselines: enabledWorlds={}, liquidTicks={}, liquidActiveCells={}, liquidRegions={}, liquidCache={}/{}/{}/{}/{}/{}/{}, fallingTicks={}, fallingPending={}, fallingProcessed={}, fallingMoved={}, wiringTicks={}, wiringInitial={}, wiringLoaded={}, wiringNetworkLoads={}, wiringEvaluated={}, wiringDirty={}/{}/{}/{}/{}/{}/{}, entity={}/{}/{}/{}/{}/{}/{}/{}/{}/{}, lua={}/{}/{}/{}/{}",
      ...
      status.phase6WiringNetworkSignatureChecks,
      status.phase6WiringCleanNetworkSignatures,
      status.phase6WiringDirtyNetworkSignatures,
      status.phase6WiringTopologyDirtyNetworkSignatures,
      status.phase6WiringOutputDirtyNetworkSignatures,
      status.phase6WiringCleanNetworkEntities,
      status.phase6WiringDirtyNetworkEntities,
      ...
      status.phase6EntityIterationCopies,
      status.phase6EntitySortedEntities,
      status.phase6EntityCopyMicroseconds,
  ...
  lines.append(strf("Phase 6 fixed-seed signatures: enabledWorlds={}, liquid=ticks:{} cells:{} activeHash:{} regionHash:{}, falling=ticks:{} pending:{} processed:{} moved:{} next:{}, wiring=ticks:{} topology:{} output:{}",
      ...
      status.phase6LiquidSignatureActiveCells,
      status.phase6LiquidSignatureActiveCellHash,
      status.phase6LiquidSignatureRegionHash,
      status.phase6FallingBlocksSignatureTicks,
      status.phase6FallingBlocksPendingPositionSignature,
      status.phase6FallingBlocksProcessedPositionSignature,
      status.phase6FallingBlocksMovedBlockSignature,
      status.phase6FallingBlocksNextPendingPositionSignature,
      status.phase6WiringSignatureTicks,
      status.phase6WiringTopologySignatureHash,
      status.phase6WiringOutputSignatureHash));
...
String CommandProcessor::worldStats(ConnectionId connectionId, String const&) {
  ...
  for (auto const& world : summary.worlds) {
    ...
    lines.append(strf("world {}: state={}, clients={}, commands=pending:{} oldestPendingUs:{} processed:{} direct:{} failed:{} waitUs:{}, packetPrep=ticks:{} regions:{}/{}/{}/{} sectorCache:{}/{} entityStoreCache:{}/{} netStateCache:{}/{} entityUpdateSets:{}/{}/{}/{} sectorFanout:{}/{}/{} entitySerialize:{} storageTiming={}, phase6=storage:{}/{}/{} sectors:{} fallbacks:{} divergences:{} packetPrefill:{}/{}/{} sectors:{} fallbacks:{} divergences:{} baselines:liquid:{} liquidCache:{}/{}/{}/{}/{}/{}/{} falling:{} wiring:{}/{}/{}/{}/{} dirty:{}/{}/{}/{}/{}/{}/{} entity:{}/{}/{}/{}/{}/{}/{}/{}/{}/{} lua:{}/{}/{}/{}/{} signatures:liquid:{}/{}/{}/{} falling:{}/{}/{}/{}/{} wiring:{}/{}/{} mutation=requested:{} blocked:fixedSeed:{} dependency:{} modVisibility:{} implementation:{}",
        ...
        phase6.wiringInitialEntities,
        phase6.wiringLoadedEntities,
        phase6.wiringNetworkLoads,
        phase6.wiringEvaluatedEntities,
        phase6.wiringNetworkSignatureChecks,
        phase6.wiringCleanNetworkSignatures,
        phase6.wiringDirtyNetworkSignatures,
        phase6.wiringTopologyDirtyNetworkSignatures,
        phase6.wiringOutputDirtyNetworkSignatures,
        phase6.wiringCleanNetworkEntities,
        phase6.wiringDirtyNetworkEntities,
        phase6.entityBaselineTicks,
        phase6.entityUpdatedEntities,
        phase6.entityTileEntities,
        phase6.entityDestroyedEntities,
        phase6.entityIterationCopies,
        phase6.entitySortedEntities,
        phase6.entityCopyMicroseconds,
        ...
        phase6.liquidSignatureRegionHash,
        phase6.fallingBlocksSignatureTicks,
        phase6.fallingBlocksPendingPositionSignature,
        phase6.fallingBlocksProcessedPositionSignature,
        phase6.fallingBlocksMovedBlockSignature,
        phase6.fallingBlocksNextPendingPositionSignature,
        phase6.wiringSignatureTicks,
        phase6.wiringTopologySignatureHash,
        phase6.wiringOutputSignatureHash,
